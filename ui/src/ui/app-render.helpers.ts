  ...
  return html`
    <div class="chat-controls">
      <label class="field chat-controls__session">
        <select
          ...
          @change=${(e: Event) => {
            ...
            (state as unknown as ClawXApp).chatStreamStartedAt = null;
            state.chatRunId = null;
            (state as unknown as ClawXApp).resetToolStream();
            (state as unknown as ClawXApp).resetChatScroll();
            state.applySettings({
              ...state.settings,
              sessionKey: next,
      ...
      <button
        ...
        @click=${async () => {
          const app = state as unknown as ClawXApp;
