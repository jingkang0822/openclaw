...
export function listMattermostAccountIds(cfg: ClawXConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: ClawXConfig): string {
...
export function listEnabledMattermostAccounts(cfg: ClawXConfig): ResolvedMattermostAccount[] {
