import type { ChannelOnboardingAdapter, ClawXConfig, WizardPrompter } from "clawx/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.clawx.ai/channels/mattermost",
    ].join("\n"),
