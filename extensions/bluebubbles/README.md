...
This directory contains the **BlueBubbles external channel plugin** for ClawX.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `clawx/plugin-sdk` helpers.
