...
import type { ClawXPluginApi, ClawXPluginToolContext } from "../../../src/plugins/types.js";
import { createLobsterTool } from "./lobster-tool.js";

async function writeFakeLobsterScript(scriptBody: string, prefix = "clawx-lobster-plugin-") {
...
function fakeApi(overrides: Partial<ClawXPluginApi> = {}): ClawXPluginApi {
  return {
    id: "lobster",
    name: "lobster",
    source: "test",
...
function fakeCtx(overrides: Partial<ClawXPluginToolContext> = {}): ClawXPluginToolContext {
  return {
    config: {},
    workspaceDir: "/tmp",
    agentDir: "/tmp",
...
describe("lobster plugin tool", () => {
  ...
  it("can be gated off in sandboxed contexts", async () => {
    const api = fakeApi();
    const factoryTool = (ctx: ClawXPluginToolContext) => {
      if (ctx.sandboxed) {
        return null;
      }
