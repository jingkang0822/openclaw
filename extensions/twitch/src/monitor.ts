...
import type { ReplyPayload, ClawXConfig } from "clawx/plugin-sdk";
import { createReplyPrefixOptions } from "clawx/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as ClawXConfig;
