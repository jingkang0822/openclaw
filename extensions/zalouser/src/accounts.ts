...
export function listZalouserAccountIds(cfg: ClawXConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: ClawXConfig): string {
...
function mergeZalouserAccountConfig(cfg: ClawXConfig, accountId: string): ZalouserAccountConfig {
