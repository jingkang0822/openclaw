...
- Version alignment with core ClawX release numbers.
...
- First public release of the @clawx/voice-call plugin.
...
- CLI: `clawx voicecall` commands (call/start/continue/speak/end/status/tail/expose).
