...
Nostr DM channel plugin for ClawX using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to ClawX. It enables your bot to:
...
# Configure clawx to use local relay
