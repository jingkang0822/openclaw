...
export function listGoogleChatAccountIds(cfg: ClawXConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: ClawXConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: ClawXConfig): ResolvedGoogleChatAccount[] {
