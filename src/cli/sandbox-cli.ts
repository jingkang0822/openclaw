...
const SANDBOX_EXAMPLES = {
  main: [
    ["clawx sandbox list", "List all sandbox containers."],
    ["clawx sandbox list --browser", "List only browser containers."],
    ["clawx sandbox recreate --all", "Recreate all containers."],
    ["clawx sandbox recreate --session main", "Recreate a specific session."],
    ["clawx sandbox recreate --agent mybot", "Recreate agent containers."],
    ["clawx sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["clawx sandbox list", "List all sandbox containers."],
    ["clawx sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["clawx sandbox recreate --all", "Recreate all containers."],
    ["clawx sandbox recreate --session main", "Recreate a specific session."],
    ["clawx sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["clawx sandbox recreate --browser --all", "Recreate only browser containers."],
    ["clawx sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["clawx sandbox explain", "Show effective sandbox config."],
    ["clawx sandbox explain --session agent:main:main", "Explain a specific session."],
    ["clawx sandbox explain --agent work", "Explain an agent sandbox."],
    ["clawx sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.clawx.ai/cli/sandbox")}\n`,
    )
    .action(() => {
