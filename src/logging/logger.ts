...
export const DEFAULT_LOG_DIR = "/tmp/clawx";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "clawx.log"); // legacy single-file path

const LOG_PREFIX = "clawx";
...
function resolveSettings(): ResolvedSettings {
  let cfg: ClawXConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => ClawXConfig;
      };
