...
export const A2UI_PATH = "/__clawx__/a2ui";

export const CANVAS_HOST_PATH = "/__clawx__/canvas";

export const CANVAS_WS_PATH = "/__clawx__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.clawxCanvasA2UIAction.postMessage(...)
  // - Android: window.clawxCanvasA2UIAction.postMessage(...)
  const handlerNames = ["clawxCanvasA2UIAction"];
  ...
  globalThis.ClawX = globalThis.ClawX ?? {};
  globalThis.ClawX.postMessage = postToNode;
  globalThis.ClawX.sendUserAction = sendUserAction;
  globalThis.clawxPostMessage = postToNode;
  globalThis.clawxSendUserAction = sendUserAction;
