...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "clawx-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveClawXPackageRoot } = await import("./clawx-root.js");
    ...
    vi.mocked(resolveClawXPackageRoot).mockResolvedValue("/opt/clawx");
