...
async function isPluginConfigured(plugin: ChannelPlugin, cfg: ClawXConfig): Promise<boolean> {
...
export async function listConfiguredMessageChannels(cfg: ClawXConfig): Promise<MessageChannelId[]> {
