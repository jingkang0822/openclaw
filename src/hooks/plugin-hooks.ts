...
import type { ClawXPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: ClawXPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: ClawXPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
