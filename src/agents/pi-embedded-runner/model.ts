...
// pi-ai's built-in Anthropic catalog can lag behind ClawX's defaults/docs.
...
export function buildModelAliasLines(cfg?: ClawXConfig) {
...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveClawXAgentDir();
