...
function resolveAvatarSource(cfg: ClawXConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: ClawXConfig, agentId: string): AgentAvatarResolution {
