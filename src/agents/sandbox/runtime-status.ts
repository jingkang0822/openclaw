...
function resolveMainSessionKeyForSandbox(params: { cfg?: ClawXConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: ClawXConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(`- See: ${formatCliCommand(`clawx sandbox explain --session ${runtime.sessionKey}`)}`);
