...
export const DEFAULT_SANDBOX_IMAGE = "clawx-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "clawx-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "clawx-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "clawx-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "clawx-sbx-browser-";
