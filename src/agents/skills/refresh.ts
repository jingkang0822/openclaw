...
function resolveWatchPaths(workspaceDir: string, config?: ClawXConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: ClawXConfig }) {
