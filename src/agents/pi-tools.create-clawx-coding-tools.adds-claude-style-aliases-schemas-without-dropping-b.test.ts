...
describe("createClawXCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createClawXCodingTools({
      config,
    ...
    const anthropicTools = createClawXCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createClawXCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createClawXCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
