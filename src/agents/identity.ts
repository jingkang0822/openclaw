import type { ClawXConfig, HumanDelayConfig, IdentityConfig } from "../config/config.js";
...
export function resolveAckReaction(cfg: ClawXConfig, agentId: string): string {
...
export function resolveIdentityNamePrefix(cfg: ClawXConfig, agentId: string): string | undefined {
...
export function resolveIdentityName(cfg: ClawXConfig, agentId: string): string | undefined {
...
export function resolveMessagePrefix(
  ...
  return resolveIdentityNamePrefix(cfg, agentId) ?? opts?.fallback ?? "[clawx]";
}

/** Helper to extract a channel config value by dynamic key. */
function getChannelConfig(cfg: ClawXConfig, channel: string): Record<string, unknown> | undefined {
