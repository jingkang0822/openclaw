...
export function listSlackAccountIds(cfg: ClawXConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: ClawXConfig): string {
...
function resolveAccountConfig(cfg: ClawXConfig, accountId: string): SlackAccountConfig | undefined {
  const accounts = cfg.channels?.slack?.accounts;
  if (!accounts || typeof accounts !== "object") {
    return undefined;
  }
...
function mergeSlackAccountConfig(cfg: ClawXConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: ClawXConfig): ResolvedSlackAccount[] {
