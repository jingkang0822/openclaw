...
function resolveConfiguredModelRaw(cfg: ClawXConfig): string {
...
function resolveConfiguredModelKeys(cfg: ClawXConfig): string[] {
...
export function applyPrimaryModel(cfg: ClawXConfig, model: string): ClawXConfig {
...
export function applyModelAllowlist(cfg: ClawXConfig, models: string[]): ClawXConfig {
  const defaults = cfg.agents?.defaults;
