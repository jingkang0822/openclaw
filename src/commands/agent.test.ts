...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "clawx-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<ClawXConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<ClawXConfig["telegram"]>>,
