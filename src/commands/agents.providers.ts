...
function resolveDefaultAccountId(cfg: ClawXConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: ClawXConfig): boolean {
...
export function summarizeBindings(cfg: ClawXConfig, bindings: AgentBinding[]): string[] {
