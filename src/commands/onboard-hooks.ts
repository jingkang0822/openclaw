...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.clawx.ai/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("clawx hooks list")}`,
      `  ${formatCliCommand("clawx hooks enable <name>")}`,
      `  ${formatCliCommand("clawx hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
