...
export type { ClawXConfig } from "../config/config.js";
/** @deprecated Use ClawXConfig instead */
export type { ClawXConfig as ClawdbotConfig } from "../config/config.js";
