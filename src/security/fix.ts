...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof ClawXConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: ClawXConfig; env: NodeJS.ProcessEnv }): {
  cfg: ClawXConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
