...
import type { GatewayBindMode, GatewayTailscaleMode, ClawXConfig } from "../config/config.js";
...
export async function configureGatewayForOnboarding(
  ...
  if (tailscaleMode !== "off" && flow !== "quickstart") {
    await prompter.note(
      ["Docs:", "https://docs.clawx.ai/gateway/tailscale", "https://docs.clawx.ai/web"].join("\n"),
      "Tailscale",
    );
