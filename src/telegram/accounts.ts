...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.CLAWX_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: ClawXConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: ClawXConfig): string {
...
function mergeTelegramAccountConfig(cfg: ClawXConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: ClawXConfig): ResolvedTelegramAccount[] {
