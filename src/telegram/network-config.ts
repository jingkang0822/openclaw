...
export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV = "CLAWX_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "CLAWX_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
