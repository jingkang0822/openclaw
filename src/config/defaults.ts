...
function resolveAnthropicDefaultAuthMode(cfg: ClawXConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: ClawXConfig): ClawXConfig {
...
export function applyTalkApiKey(config: ClawXConfig): ClawXConfig {
...
export function applyModelDefaults(cfg: ClawXConfig): ClawXConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: ClawXConfig): ClawXConfig {
...
export function applyLoggingDefaults(cfg: ClawXConfig): ClawXConfig {
...
export function applyContextPruningDefaults(cfg: ClawXConfig): ClawXConfig {
...
export function applyCompactionDefaults(cfg: ClawXConfig): ClawXConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
