...
export type ChannelAgentToolFactory = (params: { cfg?: ClawXConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: ClawXConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: ClawXConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: ClawXConfig }) => boolean;
  supportsCards?: (params: { cfg: ClawXConfig }) => boolean;
