...
function resolveMentionPatterns(cfg: ClawXConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: ClawXConfig | undefined, agentId?: string): RegExp[] {
