...
const CONFIG_KEY = Symbol.for("clawx:testConfigMock");
...
vi.mock("@whiskeysockets/baileys", () => {
  ...
  (globalThis as Record<PropertyKey, unknown>)[Symbol.for("clawx:lastSocket")] = created.lastSocket;
  return created.mod;
});
...
export function resetBaileysMocks() {
  ...
  (globalThis as Record<PropertyKey, unknown>)[Symbol.for("clawx:lastSocket")] =
...
export function getLastSocket(): MockBaileysSocket {
  const getter = (globalThis as Record<PropertyKey, unknown>)[Symbol.for("clawx:lastSocket")];
  if (typeof getter === "function") {
