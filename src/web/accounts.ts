...
export function listWhatsAppAuthDirs(cfg: ClawXConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: ClawXConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: ClawXConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: ClawXConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: ClawXConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: ClawXConfig): ResolvedWhatsAppAccount[] {
