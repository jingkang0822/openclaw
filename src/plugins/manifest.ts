...
export const PLUGIN_MANIFEST_FILENAME = "clawx.plugin.json";
...
// package.json "clawx" metadata (used for onboarding/catalog)
...
export type ClawXPackageManifest = {
  extensions?: string[];
...
): ClawXPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
