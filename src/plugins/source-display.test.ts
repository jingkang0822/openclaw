...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/clawx/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/clawx/extensions",
        global: "/Users/x/.clawx/extensions",
        workspace: "/Users/x/ws/.clawx/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.clawx/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/clawx/extensions",
        global: "/Users/x/.clawx/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.clawx/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/clawx/extensions",
        global: "/Users/x/.clawx/extensions",
