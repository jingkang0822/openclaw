...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @clawx/voice-call -> voice-call).
...
export function discoverClawXPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".clawx", "extensions")];
