...
export function listSignalAccountIds(cfg: ClawXConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: ClawXConfig): string {
...
function mergeSignalAccountConfig(cfg: ClawXConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: ClawXConfig): ResolvedSignalAccount[] {
