...
export function listBindings(cfg: ClawXConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: ClawXConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: ClawXConfig) {
