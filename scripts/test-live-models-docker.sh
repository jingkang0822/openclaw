...
docker run --rm -t \
  ...
  -e CLAWX_LIVE_TEST=1 \
  -e CLAWX_LIVE_MODELS="${CLAWX_LIVE_MODELS:-${CLAWX_LIVE_MODELS:-all}}" \
  -e CLAWX_LIVE_PROVIDERS="${CLAWX_LIVE_PROVIDERS:-${CLAWX_LIVE_PROVIDERS:-}}" \
  -e CLAWX_LIVE_MODEL_TIMEOUT_MS="${CLAWX_LIVE_MODEL_TIMEOUT_MS:-${CLAWX_LIVE_MODEL_TIMEOUT_MS:-}}" \
  -e CLAWX_LIVE_REQUIRE_PROFILE_KEYS="${CLAWX_LIVE_REQUIRE_PROFILE_KEYS:-${CLAWX_LIVE_REQUIRE_PROFILE_KEYS:-}}" \
