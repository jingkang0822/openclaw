...
show_usage() {
    cat << EOF
clawlog - ClawX Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View ClawX logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    ClawX logs flow through the macOS unified log (subsystem: ai.clawx).
