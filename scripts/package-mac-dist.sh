...
# Output:
# - dist/ClawX.app
# - dist/ClawX-<version>.zip
# - dist/ClawX-<version>.dmg
...
ZIP="$ROOT_DIR/dist/ClawX-$VERSION.zip"
DMG="$ROOT_DIR/dist/ClawX-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/ClawX-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/ClawX-$VERSION.dSYM.zip"
