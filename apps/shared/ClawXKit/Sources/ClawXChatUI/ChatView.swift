...
@MainActor
public struct ClawXChatView: View {
    public enum Style {
        case standard
        case onboarding
    }
    ...
    private var visibleMessages: [ClawXChatMessage] {
        let base: [ClawXChatMessage]
    ...
    private func mergeToolResults(in messages: [ClawXChatMessage]) -> [ClawXChatMessage] {
    ...
    private func isToolResultMessage(_ message: ClawXChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: ClawXChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: ClawXChatMessage) -> String {
