...
public typealias ClawXPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias ClawXPlatformImage = UIImage
#endif

public struct ClawXChatUsageCost: Codable, Hashable, Sendable {
...
public struct ClawXChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: ClawXChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(ClawXChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct ClawXChatMessageContent: Codable, Hashable, Sendable {
...
public struct ClawXChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [ClawXChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: ClawXChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [ClawXChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: ClawXChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(ClawXChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([ClawXChatMessageContent].self, forKey: .content) {
...
public struct ClawXChatHistoryPayload: Codable, Sendable {
...
public struct ClawXSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct ClawXSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [ClawXSessionPreviewItem]
}

public struct ClawXSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [ClawXSessionPreviewEntry]

    public init(ts: Int, previews: [ClawXSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct ClawXChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct ClawXChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct ClawXAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct ClawXChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct ClawXGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct ClawXPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: ClawXPlatformImage?
...
public struct ClawXChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
