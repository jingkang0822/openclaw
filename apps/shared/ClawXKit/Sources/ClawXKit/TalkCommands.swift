...
public enum ClawXTalkCommand: String, Codable, Sendable {
...
public struct ClawXTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct ClawXTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
