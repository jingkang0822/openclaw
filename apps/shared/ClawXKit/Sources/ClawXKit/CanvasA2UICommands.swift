...
public enum ClawXCanvasA2UICommand: String, Codable, Sendable {
...
public struct ClawXCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct ClawXCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
