...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .clawxSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? ClawXPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? ClawXPaths.stateDirURL.path
...
extension Notification.Name {
    static let clawxSelectSettingsTab = Notification.Name("clawxSelectSettingsTab")
}
