...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.clawx", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return ClawXConfigFile.defaultWorkspaceURL() }
