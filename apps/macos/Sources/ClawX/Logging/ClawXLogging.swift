...
enum ClawXLogging {
    ...
    private static let didBootstrap: Void = {
        LoggingSystem.bootstrap { label in
            ...
            let osHandler = ClawXOSLogHandler(subsystem: subsystem, category: category)
            let fileHandler = ClawXFileLogHandler(label: label)
...
extension Logging.Logger {
    init(subsystem: String, category: String) {
        ...
        let label = ClawXLogging.makeLabel(subsystem: subsystem, category: category)
...
struct ClawXOSLogHandler: LogHandler {
...
struct ClawXFileLogHandler: LogHandler {
    let label: String
    var metadata: Logger.Metadata = [:]
        ...
        line: UInt)
    {
        ...
        let (subsystem, category) = ClawXLogging.parseLabel(self.label)
