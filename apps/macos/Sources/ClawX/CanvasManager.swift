...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.clawx", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("ClawX/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__clawx__/a2ui/").absoluteString + "?platform=macos"
    }
