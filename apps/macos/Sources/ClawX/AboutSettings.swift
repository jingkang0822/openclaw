...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/clawx/clawx") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/clawx/clawx")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://clawx.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "ClawXBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "ClawXBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "ClawXGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "ClawXGitCommit") as? String) ??
            "unknown"
    }
