...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.clawx", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".clawx/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.clawxCommand(
            subcommand: "gateway",
