...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.clawx", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.clawx", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [ClawXChatMessage] = messages.compactMap { item in
