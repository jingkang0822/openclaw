...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.clawx", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other ClawX windows, but below the system’s pop-up menus.
