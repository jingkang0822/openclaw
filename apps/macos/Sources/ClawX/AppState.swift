...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = ClawXConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = ClawXConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = ClawXConfigFile.loadDict()
            ...
            if connectionMode == .remote {
                ...
                if remoteTransport == .direct {
                    ...
                    if let host = remoteHost {
                        ...
                        let port = parsedExisting?.port ?? 19789
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/clawx"
        state.remoteCliPath = ""
        return state
    }
}
