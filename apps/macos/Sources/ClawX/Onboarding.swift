...
enum UIStrings {
    static let welcomeTitle = "Welcome to ClawX"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: ClawXOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: ClawXChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g clawx@\(version)"
    }
