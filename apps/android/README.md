## ClawX Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_clawx-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm clawx gateway --port 19789 --verbose
```
