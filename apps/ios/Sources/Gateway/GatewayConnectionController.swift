...
final class GatewayConnectionController {
    ...
    private func currentCaps() -> [String] {
        ...
        caps.append(ClawXCapability.device.rawValue)
        caps.append(ClawXCapability.photos.rawValue)
        caps.append(ClawXCapability.contacts.rawValue)
        caps.append(ClawXCapability.calendar.rawValue)
        caps.append(ClawXCapability.reminders.rawValue)
        if Self.motionAvailable() {
            caps.append(ClawXCapability.motion.rawValue)
        }
    ...
    private func currentCommands() -> [String] {
        var commands: [String] = [
            ...
            ClawXChatCommand.push.rawValue,
        ...
        if caps.contains(ClawXCapability.device.rawValue) {
            commands.append(ClawXDeviceCommand.status.rawValue)
            commands.append(ClawXDeviceCommand.info.rawValue)
        }
        if caps.contains(ClawXCapability.photos.rawValue) {
            commands.append(ClawXPhotosCommand.latest.rawValue)
        }
        if caps.contains(ClawXCapability.contacts.rawValue) {
            commands.append(ClawXContactsCommand.search.rawValue)
            commands.append(ClawXContactsCommand.add.rawValue)
        }
        if caps.contains(ClawXCapability.calendar.rawValue) {
            commands.append(ClawXCalendarCommand.events.rawValue)
            commands.append(ClawXCalendarCommand.add.rawValue)
        }
        if caps.contains(ClawXCapability.reminders.rawValue) {
            commands.append(ClawXRemindersCommand.list.rawValue)
            commands.append(ClawXRemindersCommand.add.rawValue)
        }
        if caps.contains(ClawXCapability.motion.rawValue) {
            commands.append(ClawXMotionCommand.activity.rawValue)
            commands.append(ClawXMotionCommand.pedometer.rawValue)
        }
