...
final class ScreenController {
    ...
    /// Callback invoked when an clawx:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = ClawXKitResources.bundle
...
/// Handles navigation policy to intercept clawx:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept clawx:// deep links.
        if url.scheme?.lowercased() == "clawx" {
