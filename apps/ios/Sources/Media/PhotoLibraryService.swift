...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: ClawXPhotosLatestParams) async throws -> ClawXPhotosLatestPayload {
        ...
        return ClawXPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> ClawXPhotoPayload
    {
