...
final class NodeAppModel {
    ...
    private func resolveA2UIHostURL() async -> String? {
        ...
        return base.appendingPathComponent("__clawx__/a2ui/").absoluteString + "?platform=ios"
    }
    ...
    private func handleInvoke(_ req: BridgeInvokeRequest) async -> BridgeInvokeResponse {
        ...
        do {
            switch command {
            case ClawXLocationCommand.get.rawValue:
            ...
            case ClawXScreenCommand.record.rawValue:
