...
- Same path: run the app from a fixed location (for ClawX, `dist/ClawX.app`).
...
Workaround: move files into the ClawX workspace (`~/.clawx/workspace`) if you want to avoid per-folder grants.
