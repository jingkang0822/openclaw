...
You can point ClawX at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or ClawX
...
- [Anthropic provider](/providers/anthropic) - Native ClawX integration with Claude setup-token or API keys
