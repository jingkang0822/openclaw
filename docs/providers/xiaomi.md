---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with ClawX"
read_when:
  - You want Xiaomi MiMo models in ClawX
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). ClawX uses
