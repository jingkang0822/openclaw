...
Deepgram is a speech-to-text API. In ClawX it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, ClawX uploads the audio file to Deepgram and injects the transcript
