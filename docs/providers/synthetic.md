---
summary: "Use Synthetic's Anthropic-compatible API in ClawX"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. ClawX registers it as the
...
Note: ClawX's Anthropic client appends `/v1` to the base URL, so use
