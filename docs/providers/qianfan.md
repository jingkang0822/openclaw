---
summary: "Use Qianfan's unified API to access many models in ClawX"
read_when:
...
3. ClawX installed on your system
...
4. Copy the API key for use with ClawX

## CLI setup

```bash
clawx onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [ClawX Configuration](/gateway/configuration)
