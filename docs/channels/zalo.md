...
- Install via CLI: `clawx plugins install @clawx/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `clawx plugins install ./extensions/zalo`
   - From npm (if published): `clawx plugins install @clawx/zalo`
...
- Approve via:
  - `clawx pairing list zalo`
  - `clawx pairing approve zalo <CODE>`
...
- Example: `clawx message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `clawx channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `clawx logs --follow`
