...
ClawX has two separate “streaming” layers:
...
When block streaming is enabled, ClawX can **merge consecutive block chunks**
...
When draft streaming is active, ClawX disables block streaming for that reply to avoid double-streaming.
