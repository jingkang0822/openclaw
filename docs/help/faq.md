---
summary: "Frequently asked questions about ClawX setup, configuration, and usage"
title: "FAQ"
---
...
- [Quick start and first-run setup]
  ...
  - [What's the recommended way to install and set up ClawX?](#whats-the-recommended-way-to-install-and-set-up-clawx)
  ...
  - [I can't access docs.clawx.ai (SSL error). What now?](#i-cant-access-docsclawxai-ssl-error-what-now)
  - [What's the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
  - [How do I install the beta version, and what's the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or clawx not recognized](#windows-install-says-git-not-found-or-clawx-not-recognized)
  - [The docs didn't answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install ClawX on Linux?](#how-do-i-install-clawx-on-linux)
  - [How do I install ClawX on a VPS?](#how-do-i-install-clawx-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask ClawX to update itself?](#can-i-ask-clawx-to-update-itself)
  ...
  - [If I buy a Mac mini to run ClawX, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-clawx-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different ClawX instances?](#can-multiple-people-use-one-whatsapp-number-with-different-clawx-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run ClawX on a dedicated machine?](#how-important-is-it-to-run-clawx-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run ClawX in a VM and what are the requirements](#can-i-run-clawx-in-a-vm-and-what-are-the-requirements)
- [What is ClawX?](#what-is-clawx)
  - [What is ClawX, in one paragraph?](#what-is-clawx-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for ClawX](#what-are-the-top-five-everyday-use-cases-for-clawx)
  - [Can ClawX help with lead gen outreach ads and blogs for a SaaS](#can-clawx-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can ClawX run tasks on a schedule or continuously in the background?](#can-clawx-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with ClawX saved locally?](#is-all-data-used-with-clawx-saved-locally)
  - [Where does ClawX store its data?](#where-does-clawx-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall ClawX?](#how-do-i-completely-uninstall-clawx)
...
- [Config basics](#config-basics)
  ...
  - [Can the ClawX browser run headless?](#can-the-clawx-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two ClawX instances talk to each other (local + VPS)?](#can-two-clawx-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does ClawX load environment variables?](#how-does-clawx-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of ClawX instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-clawx-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset ClawX but keep it installed?](#how-do-i-completely-reset-clawx-but-keep-it-installed)
  ...
  - [Why doesn't ClawX reply in a group?](#why-doesnt-clawx-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do ClawX, Flawd, and Krill use for models?](#what-do-clawx-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `clawx gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-clawx-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `clawx gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-clawx-gateway-status-show-config-cli-and-config-service-different)
  - [What does "another gateway instance is already listening" mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run ClawX in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-clawx-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart ClawX?](#i-closed-my-terminal-on-windows-how-do-i-restart-clawx)
  ...
  - [ELI5: `clawx gateway restart` vs `clawx gateway`](#eli5-clawx-gateway-restart-vs-clawx-gateway)
  - [What's the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media and attachments](#media-and-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose ClawX to inbound DMs?](#is-it-safe-to-expose-clawx-to-inbound-dms)
...
5. **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/clawx/clawx-*.log | head -1)"
   ```
...
7. **Gateway snapshot**
   ...
   ```bash
   clawx health --json
   clawx health --verbose   # shows the target URL + config path on errors
   ```
...
```bash
curl -fsSL https://clawx.ai/install.sh | bash -s -- --install-method git
```

This installs ClawX **from a git checkout**, so the agent can read the code + docs and
...
[https://github.com/clawx/clawx/issues](https://github.com/clawx/clawx/issues)
[https://github.com/clawx/clawx/pulls](https://github.com/clawx/clawx/pulls)
...
- `clawx status`: quick snapshot of gateway/agent health + basic config.
- `clawx models status`: checks provider auth + model availability.
- `clawx doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `clawx status --all`, `clawx logs --follow`,
`clawx gateway status`, `clawx health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up ClawX

The repo recommends running from source and using the onboarding wizard:

```bash
curl -fsSL https://clawx.ai/install.sh | bash
clawx onboard --install-daemon
```

The wizard can also build UI assets automatically. After onboarding, you typically run the Gateway on port **19789**.
...
If you don't have a global install yet, run it via `pnpm clawx onboard`.
...
- If it asks for auth, paste the token from `gateway.auth.token` (or `CLAWX_GATEWAY_TOKEN`) into Control UI settings.
- Retrieve it from the gateway host: `clawx config get gateway.auth.token` (or generate one: `clawx doctor --generate-gateway-token`).

**Not on localhost:**

- **Tailscale Serve** (recommended): keep bind loopback, run `clawx gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy auth (no token).
- **Tailnet bind**: run `clawx gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:19789/`, paste token in dashboard settings.
- **SSH tunnel**: `ssh -N -L 19789:127.0.0.1:19789 user@host` then open `http://127.0.0.1:19789/` and paste the token in Control UI settings.
...
1. Install ClawX on the new machine.
2. Copy `$CLAWX_STATE_DIR` (default: `~/.clawx`) from the old machine.
3. Copy your workspace (default: `~/.clawx/workspace`).
4. Run `clawx doctor` and restart the Gateway service.
...
under `~/.clawx/` (for example `~/.clawx/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-clawx-store-its-data),
...
[https://github.com/clawx/clawx/blob/main/CHANGELOG.md](https://github.com/clawx/clawx/blob/main/CHANGELOG.md)

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I cant access docs.clawx.ai SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.clawx.ai` via Xfinity
Advanced Security. Disable it or allowlist `docs.clawx.ai`, then retry. More
detail: [Troubleshooting](/help/troubleshooting#docsclawxai-shows-an-ssl-error-comcastxfinity).
Please help us unblock it by reporting here: [https://spa.xfinity.com/check_url_status](https://spa.xfinity.com/check_url_status).

If you still can't reach the site, the docs are mirrored on GitHub:
[https://github.com/clawx/clawx/tree/main/docs](https://github.com/clawx/clawx/tree/main/docs)
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://clawx.ai/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https://clawx.ai/install.sh | bash -s -- --install-method git
```

Windows installer (PowerShell):
[https://clawx.ai/install.ps1](https://clawx.ai/install.ps1)
...
```bash
curl -fsSL https://clawx.ai/install.sh | bash -s -- --verbose
```

Beta install with verbose:

```bash
curl -fsSL https://clawx.ai/install.sh | bash -s -- --beta --verbose
```

For a hackable (git) install:

```bash
curl -fsSL https://clawx.ai/install.sh | bash -s -- --install-method git --verbose
```

More options: [Installer flags](/install/installer).

### Windows install says git not found or clawx not recognized
...
**2) clawx is not recognized after install**
...
### How do I install ClawX on Linux
...
### How do I install ClawX on a VPS
...
### Can I ask ClawX to update itself
...
clawx update
clawx update status
clawx update --channel stable|beta|dev
clawx update --tag <dist-tag|version>
clawx update --no-restart
```

If you must automate from an agent:

```bash
clawx update --yes --no-restart
clawx gateway restart
```
...
`clawx onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run ClawX with **API keys** (Anthropic/OpenAI/others) or with
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `clawx models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `clawx models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `clawx models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro or Max)

Yes - via **setup-token**. ClawX no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so ClawX can keep replying while a provider is rate-limited.
...
ClawX supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.3-codex` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. ClawX fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `clawx.json`.

Steps:

1. Enable the plugin: `clawx plugins enable google-gemini-cli-auth`
2. Login: `clawx models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. ClawX needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. ClawX runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
### If I buy a Mac mini to run ClawX can I connect it to my MacBook Pro
...
- Use `clawx nodes status` / `clawx nodes list` to see it.
...
- DM your bot, then run `clawx logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different ClawX instances
...
If you run ClawX via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non-login shells.
...
This **does not delete your data** - it only changes the ClawX code install. Your state
(`~/.clawx`) and workspace (`~/.clawx/workspace`) stay untouched.
...
**ClawX-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you're actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run ClawX on a dedicated machine
...
ClawX is lightweight. For a basic Gateway + one chat channel:
...
### Can I run ClawX in a VM and what are the requirements
...
### What is ClawX in one paragraph

ClawX is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

ClawX is not "just a Claude wrapper." It's a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for ClawX
...
### Can ClawX help with lead gen outreach ads and blogs for a SaaS
...
ClawX draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

ClawX is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use ClawX when you
...
Showcase: [https://clawx.ai/showcase](https://clawx.ai/showcase)

## Skills and automation

### How do I customize skills without keeping the repo dirty

Use managed overrides instead of editing the repo copy. Put your changes in `~/.clawx/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.clawx/clawx.json`). Precedence is `<workspace>/skills` > `~/.clawx/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.clawx/clawx.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.clawx/skills` → bundled → `skills.load.extraDirs`. `clawhub` installs into `./skills` by default, which ClawX treats as `<workspace>/skills`.
...
- Confirm cron is enabled (`cron.enabled`) and `CLAWX_SKIP_CRON` is not set.
...
```bash
clawx cron run <jobId> --force
clawx cron runs --id <jobId> --limit 50
```
...
### Can ClawX run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.clawx.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `apple-notes`, `apple-reminders`, `things-mac`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-clawx-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. ClawX can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.clawx/skills`) to allow Linux:

   ```markdown
   ---
   name: apple-notes
   description: Manage Apple Notes via the memo CLI on macOS.
   metadata: { "clawx": { "os": ["darwin", "linux"], "requires": { "bins": ["memo"] } } }
   ---
   ```
...
ClawHub installs into `./skills` under your current directory (or falls back to your configured ClawX workspace); ClawX treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.clawx/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawHub](/tools/clawhub).
...
```bash
clawx browser extension install
clawx browser extension path
```
...
- Persist `/home/node` with `CLAWX_HOME_VOLUME` so caches survive.
- Bake system deps into the image with `CLAWX_DOCKER_APT_PACKAGES`.
...
ClawX memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

ClawX also runs a **silent pre-compaction memory flush** to remind the model
...
If you don't set a provider explicitly, ClawX auto-selects a provider when it
can resolve an API key (auth profiles, `models.providers.*.apiKey`, or env vars).
It prefers OpenAI if an OpenAI key resolves, otherwise Gemini if a Gemini key
resolves. If neither key is available, memory search stays disabled until you
configure it. If you have a local model path configured and present, ClawX
prefers `local`.
...
### Is all data used with ClawX saved locally

No - **ClawX's state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.clawx` + your workspace directory).
...
### Where does ClawX store its data

Everything lives under `$CLAWX_STATE_DIR` (default: `~/.clawx`):

| Path                                                         | Purpose                                                      |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| `$CLAWX_STATE_DIR/clawx.json`                                | Main config (JSON5)                                          |
| `$CLAWX_STATE_DIR/credentials/oauth.json`                    | Legacy OAuth import (copied into auth profiles on first use) |
| `$CLAWX_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth + API keys)                             |
| `$CLAWX_STATE_DIR/agents/<agentId>/agent/auth.json`          | Runtime auth cache (managed automatically)                   |
| `$CLAWX_STATE_DIR/credentials/`                              | Provider state (e.g. `whatsapp/<accountId>/creds.json`)      |
| `$CLAWX_STATE_DIR/agents/`                                   | Per-agent state (agentDir + sessions)                        |
| `$CLAWX_STATE_DIR/agents/<agentId>/sessions/`                | Conversation history & state (per agent)                     |
| `$CLAWX_STATE_DIR/agents/<agentId>/sessions/sessions.json`   | Session metadata (per agent)                                 |

Legacy single-agent path: `~/.clawx/agent/*` (migrated by `clawx doctor`).

Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/.clawx/workspace`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.clawx`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.clawx`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.clawx/skills`).

Default workspace is `~/.clawx/workspace`, configurable via:

```json5
{
  agents: { defaults: { workspace: "~/.clawx/workspace" } },
}
```
...
Do **not** commit anything under `~/.clawx` (credentials, sessions, tokens).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall ClawX
...
`workspace` to the repo root. The ClawX repo is just source code; keep the
...
ClawX reads an optional **JSON5** config from `$CLAWX_CONFIG_PATH` (default: `~/.clawx/clawx.json`):

```
$CLAWX_CONFIG_PATH
```

If the file is missing, it uses safe-ish defaults (including a default workspace of `~/.clawx/workspace`).

### I set gatewaybind lan or tailnet and now nothing listens the UI says unauthorized

Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `CLAWX_GATEWAY_TOKEN`).
...
If you **really** want open loopback, remove `gateway.auth` from your config. Doctor can generate a token for you any time: `clawx doctor --generate-gateway-token`.
...
key. **Recommended:** run `clawx configure --section web` to store it in
...
- Daemons read env vars from `~/.clawx/.env` (or the service environment).
...
### Can the ClawX browser run headless
...
- Gateway is running: `clawx gateway status`
- Gateway health: `clawx status`
- Channel health: `clawx channels status`
...
### Can two ClawX instances talk to each other local VPS
...
`clawx agent --message ... --deliver`, targeting a chat where the other bot
...
```bash
clawx agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
- Restore from backup (git or a copied `~/.clawx/clawx.json`).
- If you have no backup, re-run `clawx doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:

- Use `clawx config set` for small changes.
- Use `clawx configure` for interactive edits.
...
4. **Use the tailnet hostname**
   ...
   - Gateway WS: `ws://your-vps.tailnet-xxxx.ts.net:19789`
...
### How does ClawX load environment variables

ClawX reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.clawx/.env` (aka `$CLAWX_STATE_DIR/.env`)
...
1. Put the missing keys in `~/.clawx/.env` so they're picked up even when the service doesn't inherit your shell env.
...
`CLAWX_LOAD_SHELL_ENV=1`, `CLAWX_SHELL_ENV_TIMEOUT_MS=15000`.

### I set COPILOTGITHUBTOKEN but models status shows Shell env off Why

`clawx models status` reports whether **shell env import** is enabled. "Shell env: off"
does **not** mean your env vars are missing - it just means ClawX won't load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won't inherit your shell
environment. Fix by doing one of these:

1. Put the token in `~/.clawx/.env`:
...
### Is there a way to make a team of ClawX instances one CEO and many agents
...
### How do I completely reset ClawX but keep it installed
...
```bash
clawx reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `CLAWX_PROFILE`), reset each state dir (defaults are `~/.clawx-<profile>`).
- Dev reset: `clawx gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), ClawX skips the heartbeat run to save API calls.
...
No. ClawX runs on **your own account**, so if you're in the group, ClawX can see it.
...
```bash
clawx directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesnt ClawX reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.clawx/agents/<agentId>/sessions/`.
...
- Use `clawx doctor` to spot stray workspaces and profile mismatches.
...
ClawX's default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-6`). If you omit the provider, ClawX currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `clawx models set ...` (updates just model config)
- `clawx configure --section model` (interactive)
- edit `agents.defaults.model` in `~/.clawx/clawx.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `clawx doctor` to repair.

Docs: [Models](/concepts/models), [Configure](/cli/configure), [Config](/cli/config), [Doctor](/gateway/doctor).

### What do ClawX, Flawd, and Krill use for models

- **ClawX + Flawd:** Anthropic Opus (`anthropic/claude-opus-4-6`) - see [Anthropic](/providers/anthropic).
...
Yes. ClawX ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.clawx/agents/<agentId>/agent/auth-profiles.json
```

Fix options:

- Run `clawx agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so ClawX can keep responding even when a provider is rate-limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.clawx/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.clawx/agent/*` (migrated by `clawx doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.clawx/.env` or enable `env.shellEnv`.
- **Make sure you're editing the correct agent**
  - Multi-agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity-check model/auth status**
  - Use `clawx models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `clawx models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `clawx models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.clawx/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:

    ```bash
    clawx models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), ClawX will try it during model fallback. If you haven't configured Google credentials, you'll see `No API key found for provider "google"`.
...
Fix: ClawX now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
ClawX uses provider-prefixed IDs like:
...
ClawX may temporarily skip a profile if it's in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `clawx models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent's `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
clawx models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
clawx models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
clawx models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
clawx models auth order set --provider anthropic --agent main anthropic:default
```
...
```
--port > CLAWX_GATEWAY_PORT > gateway.port > default 19789
```

### Why does clawx gateway status say Runtime running but RPC probe failed

Because "running" is the **supervisor's** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `clawx gateway status` and trust these lines:

- `Probe target:` (the URL the probe actually used)
- `Listening:` (what's actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn't listening)

### Why does clawx gateway status show Config cli and Config service different

You're editing one config file while the service is running another (often a `--profile` / `CLAWX_STATE_DIR` mismatch).
...
ClawX enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:19789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `clawx gateway --port <port>`.

### How do I run ClawX in remote mode client connects to a Gateway elsewhere
...
- `clawx gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- The Control UI stores the token in browser localStorage key `clawx.control.settings.v1`.

Fix:

- Fastest: `clawx dashboard` (prints + copies the dashboard URL, tries to open; shows SSH hint if headless).
- If you don't have a token yet: `clawx doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 19789:127.0.0.1:19789 user@host` then open `http://127.0.0.1:19789/`.
- Set `gateway.auth.token` (or `CLAWX_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token.
- Still stuck? Run `clawx status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- `CLAWX_CONFIG_PATH` (per-instance config)
- `CLAWX_STATE_DIR` (per-instance state)
- `agents.defaults.workspace` (workspace isolation)
- `gateway.port` (unique ports)

Quick setup (recommended):

- Use `clawx --profile <name> …` per instance (auto-creates `~/.clawx-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `clawx --profile <name> gateway install`.

Profiles also suffix service names (`bot.molt.<profile>`; legacy `com.clawx.*`, `clawx-gateway-<profile>.service`, `ClawX Gateway (<profile>)`).
...
1. Use the WS URL: `ws://<host>:19789` (or `wss://...` if HTTPS).
...
```
clawx tui --url ws://<host>:19789 --token <token>
```
...
```
/tmp/clawx/clawx-YYYY-MM-DD.log
```
...
- macOS: `$CLAWX_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.clawx/logs/...`; profiles use `~/.clawx-<profile>/logs/...`)
- Linux: `journalctl --user -u clawx-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "ClawX Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `clawx gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart ClawX
...
1. Is the Gateway running? `clawx gateway status`
2. Is the Gateway healthy? `clawx status`
3. Does the UI have the right token? `clawx dashboard`
...
```bash
clawx channels status
clawx channels logs --channel telegram
```
...
### ELI5 clawx gateway restart vs clawx gateway

- `clawx gateway restart`: restarts the **background service** (launchd/systemd).
- `clawx gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `clawx gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [ClawX assistant setup](/start/clawx) and [Agent send](/tools/agent-send).

CLI sending:

```bash
clawx message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose ClawX to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM-capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `clawx pairing approve <channel> <code>`
  - Pending requests are capped at **3 per channel**; check `clawx pairing list <channel>` if a code didn't arrive.
- Opening DMs publicly requires explicit opt-in (`dmPolicy: "open"` and allowlist `"*"`).

Run `clawx doctor` to surface risky DM policies.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. ClawX only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
clawx pairing approve whatsapp <code>
```

List pending requests:

```bash
clawx pairing list whatsapp
```
...
ClawX blocks **cross-provider** messaging by default. If a tool call is bound
