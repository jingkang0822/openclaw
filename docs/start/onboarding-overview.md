---
summary: "Overview of ClawX onboarding options and flows"
read_when:
...
ClawX supports multiple onboarding paths depending on where the Gateway runs
...
- [`clawx onboard` command](/cli/onboard)

## macOS app onboarding

Use the ClawX app when you want a fully guided setup on macOS. Docs:
