---
summary: "First-run onboarding flow for ClawX (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give ClawX">
...
<Step title="CLI">
  ...
  The app can install the global `clawx` CLI via npm/pnpm so terminal
