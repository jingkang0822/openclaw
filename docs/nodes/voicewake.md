...
ClawX treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.clawx/settings/voicewake.json`

Shape:

```json
{ "triggers": ["clawx", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
