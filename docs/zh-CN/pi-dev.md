...
本指南总结了在 ClawX 中开发 Pi 集成的合理工作流程。
...
状态存储在 ClawX 状态目录下。默认为 `~/.clawx`。如果设置了 `CLAWX_STATE_DIR`，则使用该目录。
...
- https://docs.clawx.ai/testing
- https://docs.clawx.ai/start/getting-started
