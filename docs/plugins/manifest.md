...
read_when:
  - You are building a ClawX plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (clawx.plugin.json)

Every plugin **must** ship a `clawx.plugin.json` file in the **plugin root**.
ClawX uses this manifest to validate configuration **without executing plugin
