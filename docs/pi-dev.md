...
This guide summarizes a sane workflow for working on the pi integration in ClawX.
...
- Trigger the agent directly:
  - `pnpm clawx agent --message "Hello" --thinking low`
...
State lives under the ClawX state directory. Default is `~/.clawx`. If `CLAWX_STATE_DIR` is set, use that directory instead.

To reset everything:

- `clawx.json` for config
...
- [https://docs.clawx.ai/testing](https://docs.clawx.ai/testing)
- [https://docs.clawx.ai/start/getting-started](https://docs.clawx.ai/start/getting-started)
